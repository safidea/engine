...
export function testNotionIntegration(
  ...
  describe('create', () => {
    it('should create a page in a table', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a title property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a number property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const number = 123
    ...
    it('should create a page in a table with a number property from a string', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const number = '123'
    ...
    it('should create a page in a table with an empty number property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a boolean property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const boolean = true
    ...
    it('should create a page in a table with a boolean property from a string', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const boolean = 'false'
    ...
    it('should create a page in a table with a text property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const text =
    ...
    it('should create a page in a table with an empty text property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with an URL property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with an empty URL property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with an email property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with an empty email property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with an phone property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with an empty phone property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a select property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const select = '1'
    ...
    it('should create a page in a table with a status property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a multi_select property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a date property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a date property from a date string', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a date property from a date and time string', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a date property from a date, time and milliseconds string', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a date property from a timestamp', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a date property and a null value', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const date = null
    ...
    it('should create a page in a table with a people property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
    ...
    it('should create a page in a table with a files property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const files = [
        {
  ...
  describe('createMany', () => {
    it('should create many pages in a table with a title property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
  ...
  describe('updateMany', () => {
    it('should update many pages in a table with a title property', async () => {
      // GIVEN
      const table = await integration.getTable(TEST_NOTION_TABLE_1_ID)
      const pagesCreated = await table.createMany([
        {
          name: '1',
        },
        {
      ...
      const pagesUpdated = await table.updateMany(
        pagesCreated.map((page) => ({ id: page.id, page: { name: 'John Doe' } }))
      )
  ...
  if (slow) {
    describe('stress test', () => {
      it('should allow 100 requests in few seconds', async () => {
        ...
        // WHEN
        const pages = await table.createMany(values)
