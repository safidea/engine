...
import { IServerAdapter } from '@adapters/spi/server/IServerAdapter'
...
import { ServerSpi as Server } from '@adapters/spi/server/ServerSpi'
...
import { AppDto as App } from '@adapters/api/app/AppDto'
import { PageDto as Page } from '@adapters/api/page/dtos/PageDto'
import { TableDto as Table } from '@adapters/api/table/dtos/TableDto'
import { AutomationDto as Automation } from '@adapters/api/automation/dtos/AutomationDto'
