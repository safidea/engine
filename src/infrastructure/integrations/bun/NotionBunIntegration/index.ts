...
import { NotionTableBunIntegration } from './NotionTableBunIntegration'
import type { NotionConfig } from '@domain/integrations/Notion'
import type { NotionUserDto } from '@adapter/spi/dtos/NotionUserDto'
import { BunDatabaseDriver } from '@infrastructure/drivers/bun/DatabaseDriver/BunDriver'
import { BunDatabaseTableDriver } from '@infrastructure/drivers/bun/DatabaseDriver/BunTableDriver'
...
export class NotionBunIntegration implements INotionIntegration {
  private _db: BunDatabaseDriver
  private _tables?: BunDatabaseTableDriver
  private _users?: BunDatabaseTableDriver

  constructor(private _config?: NotionConfig) {
    this._db = new BunDatabaseDriver({ url: ':memory:', driver: 'Bun' })
  }
