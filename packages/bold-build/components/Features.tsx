          ...
          children: [
            {
              ...
              children: ['Deploy faster'],
            },
            {
              tag: 'p',
              class: 'mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl',
              children: ['Everything you need to deploy your app'],
            },
            {
              tag: 'p',
          ...
          children: [
            {
              tag: 'dl',
              class:
                'grid max-w-xl grid-cols-1 gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-16',
              children: [
                      ...
                      children: [
                        {
                          tag: 'div',
                          class:
                            'absolute top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600',
                          children: [
                            {
                              tag: 'feature.icon',
                              'aria-hidden': 'true',
