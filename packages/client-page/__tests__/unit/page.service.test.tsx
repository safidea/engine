...
describe('render', () => {
  it('should return a page', () => {
    const Html = PageService.render([{ key: 'div', text: 'test' }])
    render(<Html />)
  ...
  it('should return a page with children', () => {
    const Html = PageService.render([{ key: 'div', components: [{ key: 'span', text: 'test' }] }])
    render(<Html />)
  ...
  it('should return a page with props', () => {
    const Html = PageService.render([{ key: 'button', className: 'test' }])
    render(<Html />)
