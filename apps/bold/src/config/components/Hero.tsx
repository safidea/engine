...
export default function Hero({ props }: ComponentUI) {
...
Your Company
</span><Image src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" className="h-8" width="50" height="50" />
</Link>
...
</nav><Dialog as="div" open={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)}>
